...
class Logger(object):
    """
    This logger will print reported properties and log properties into files.
    """
    BEST = BEST
    LAST = LAST
    ...
    def log(self, log_dict=dict(), model=None, id=None):
        ...
        Args:
            log_dict: the dict of data {"valid_acc": value, ...}.
            model: optional pytorch model to log to.
            id: the best model is kept by the best value from the key in the data dict.
        """
        # log things
        for k in log_dict:
    ...
    def log_model(self, model, condition):
        """
        Save model to data dict "last model". If condition function returns True, also save to "best model."

        Args:
            model: pytorch model.
            condition: a function of data_dict, return bool.
        Returns:
    ...
    def load_model(self, model, id=LAST):
        ...
        Args:
            model: pytorch model
            id: which model do you want? BEST or LAST
